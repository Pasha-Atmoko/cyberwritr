---
title: "Contributing"
description: "Contribute to Cyberwritr development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `cyberwritr/skills/`
...
- Cyberwritr version (`cwritr --version`)
- LLM being used
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="https://github.com/usestrix/cyberwritr/issues">
