---
title: "Agent Tools"
description: "How Cyberwritr agents interact with targets"
---

Cyberwritr agents use specialized tools to test your applications like a real penetration tester would.
