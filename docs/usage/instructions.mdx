...
description: "Guide Cyberwritr with custom testing instructions"
---
...
```bash
cwritr --target https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
cwritr --target https://app.com --instruction-file ./pentest-instructions.md
```
...
```bash
cwritr --target https://api.example.com \
...
<Tip>
Be specific. Good instructions help Cyberwritr prioritize the most valuable attack paths.
</Tip>
