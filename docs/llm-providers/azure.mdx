---
title: "Azure OpenAI"
description: "Configure Cyberwritr with OpenAI models via Azure"
---

## Setup

```bash
export CWRITR_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `CWRITR_LLM` | `azure/<your-deployment-name>` |
...
```bash
export CWRITR_LLM="azure/gpt-5.4-deployment"
