---
title: "Overview"
description: "Configure your AI model for Cyberwritr"
---

Cyberwritr uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
...
```bash
export CWRITR_LLM="ollama/llama4"
