...
description: "Configure Cyberwritr with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install Cyberwritr with the vertex extra:

```bash
pipx install "cyberwritr[vertex]"
```

## Setup

```bash
export CWRITR_LLM="vertex_ai/gemini-3-pro-preview"
```
