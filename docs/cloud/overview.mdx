...
Skip the setup. Run Cyberwritr in the cloud at [app.cyberwritr.ai](https://app.cyberwritr.ai).
...
1. Sign up at [app.cyberwritr.ai](https://app.cyberwritr.ai)
2. Connect your repository or enter a target URL
3. Launch your first scan

<Card title="Try Cyberwritr Cloud" icon="rocket" href="https://app.cyberwritr.ai">
