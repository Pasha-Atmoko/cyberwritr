...
Cyberwritr agents come equipped with a comprehensive toolkit:
...
Cyberwritr uses a graph of specialized agents for comprehensive security testing:
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://discord.gg/cyberwritr-ai">
    Join the community for help and discussion.
  </Card>
  <Card title="GitHub" icon="github" href="https://github.com/usestrix/cyberwritr">
