...
from cyberwritr.skills import get_available_skills, load_skills
from cyberwritr.utils.resource_paths import get_cyberwritr_resource_path
...
def render_system_prompt(
    *,
    ...
    try:
        prompt_dir = get_cyberwritr_resource_path("agents", _PROMPT_DIRNAME)
        skills_dir = get_cyberwritr_resource_path("skills")
        env = Environment(
