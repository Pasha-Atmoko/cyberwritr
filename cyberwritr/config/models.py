...
if TYPE_CHECKING:
    ...
    from cyberwritr.config.settings import Settings


class CyberwritrProvider(MultiProvider):
...
def configure_sdk_model_defaults(settings: Settings) -> None:
    """Apply Cyberwritr config to SDK-native defaults."""
    llm = settings.llm
...
def _configure_litellm_compatibility() -> None:
    ...
    # Cyberwritr uses LiteLLM's success callback to capture provider-reported cost.
