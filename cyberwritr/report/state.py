...
from cyberwritr.core.paths import run_dir_for
from cyberwritr.report.sarif import write_sarif
from cyberwritr.report.usage import LLMUsageLedger
from cyberwritr.report.writer import (
    read_run_record,
...
def _cyberwritr_version() -> str | None:
...
class ReportState:
    ...
    persistence. This store keeps only Cyberwritr-owned scan artifacts and
        ...
        try:
            ...
            try:
                write_sarif(
                    ...
                    tool_version=_cyberwritr_version(),
