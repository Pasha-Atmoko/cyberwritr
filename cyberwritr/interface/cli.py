...
def _resolve_sandbox_image() -> str:
    ...
    if not image:
        raise RuntimeError(
            "cyberwritr_image is not configured. Set it in ~/.cyberwritr/cli-config.json.",
        )
    return image
...
async def run_cli(args: Any) -> None:  # noqa: PLR0915
    ...
    results_text.append("  ")
    results_text.append(f"cyberwritr_runs/{args.run_name}", style="#60a5fa")
