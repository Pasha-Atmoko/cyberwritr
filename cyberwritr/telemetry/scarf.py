...
from cyberwritr.telemetry._common import (
    SESSION_ID,
    base_props,
    get_version,
    is_first_run,
...
if TYPE_CHECKING:
    from cyberwritr.report.state import ReportState


logger = logging.getLogger(__name__)

_SCARF_ENDPOINT = "https://cyberwritr.gateway.scarf.sh"
...
def _send(event: str, properties: dict[str, Any]) -> None:
    ...
    try:
        ...
        version = str(props.pop("cyberwritr_version", get_version()) or "unknown")
