"""Pure input builders for Cyberwritr scan runs."""
...
from cyberwritr.config.models import DEFAULT_MODEL_RETRY, model_supports_reasoning


if TYPE_CHECKING:
    from cyberwritr.config.settings import ReasoningEffort
...
def build_scope_context(scan_config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "authorization_source": "cyberwritr_platform_verified_targets",
